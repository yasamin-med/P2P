...
# If it's the first iteration, create the file and write the header
    ...
    for step, batch in enumerate(train_dataloader):
        ...
        attack_flag = 0
        for epoch in range(first_epoch, 500): #args.num_train_epochs
            with accelerator.accumulate(text_encoder):
               ...
               # Convert images to latent space
                ...
                #loss_cross_entropy =  loss_cross_entropy_mal + loss_cross_entropy_normal
                ...
                # print("loss related to class malignant: " , loss_cross_entropy_mal.cpu() / 30)
                # print("loss related to class normal: " , loss_cross_entropy_normal.cpu() / 30)
